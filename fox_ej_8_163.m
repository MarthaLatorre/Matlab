...
Titulo = 'Dm, Tubería en serie o paralelo';
        ...
        RD = {'5.5e-3','4.6e-5','4.5','1.52e-6','9.81','9.81','0','0'};
...
%  eqn=((2*z1*g*pi()^2*D^5)/(16*Q^2*L)- (Kt+1)*D/L - f == 0)
  ...
  eqn= (P2/PE)+z2+ Vc + hlM+ hlm == 0 ; %% USE ((L*f(i)/D)+ Kt+1)*Vc(i) - hl == 0 SI CONOCE LA VELOCIDAD DE SALIDA
...
Er(i)=E/Dm(i);
V(i)= (4*Q)/(pi()*(Dm(i)^2)); % calcula velocidad con Q/Area
Re(i)=(V(i)*Dm(i))/v;
